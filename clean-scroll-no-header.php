<?php
/**
 * ЧИСТЫЙ СКРОЛЛ БЕЗ HEADER - скрывает шапку на десктопе
 */

function add_clean_scroll_no_header() {
    if (is_admin() || isset($_GET['elementor-preview'])) {
        return;
    }
    ?>
    <style>
        /* Стили для десктопа - плавный скролл + скрытие header */
        ...
        /* Стили для планшетов и мобильных - обычный скролл + header видим */
        @media (max-width: 1024px) {
            ...
            /* На мобильных header остается видимым */
            header,
            .site-header,
            .header,
            .elementor-location-header,
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Дополнительно скрываем header через JavaScript
...
add_action('wp_head', 'add_clean_scroll_no_header');
?>