<?php
/**
 * ИСПРАВЛЕННЫЙ СКРОЛЛ ДЛЯ ELEMENTOR - работает с любой структурой
 */

function add_fixed_single_section_scroll() {
    ...
    <div class="debug-panel">
        ...
        <div>Контейнер: <span id="debug-container">Поиск...</span></div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            console.log('🚀 Исправленный скрипт запущен');
            ...
            for (let selector of selectors) {
                ...
                if (element) {
                    ...
                    document.getElementById('debug-container').textContent = selector;
                    break;
                }
            }

            if (!container) {
                console.log('❌ Не удалось найти подходящий контейнер');
                document.getElementById('debug-container').textContent = 'НЕ НАЙДЕН';
                return;
            }
...
add_action('wp_head', 'add_fixed_single_section_scroll');
?>